...
<template>
	<UMain>
		...
		>
			...
			<template #title>
				Letní odborné soustředění<br><span class="text-primary">Běstvina</span>
			</template>
			<template #description>
				Soutředění určené pro nejlepší řešitele chemické a biologické olympiády z celé České republiky.
			</template>
			<template #links>
				<UButton
					color="secondary"
